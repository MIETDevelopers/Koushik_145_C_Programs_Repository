//Program to calculate distance between two points on a plane.
//Author == Koushik Mahajan
#include<stdio.h>//Euclidean distance between two points in a plane
#include<math.h>//variable declaration 
